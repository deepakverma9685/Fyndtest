...
import com.deepak.movielisting.data.remote.interceptor.NetworkInterceptor
import com.deepak.movielisting.data.remote.interceptor.RequestInterceptor
...
class ApiModule {
    ...
    @Provides
    @Singleton
    internal fun provideMovieApiService(retrofit: Retrofit): UrlServcies {
        return retrofit.create(UrlServcies::class.java)
    }
